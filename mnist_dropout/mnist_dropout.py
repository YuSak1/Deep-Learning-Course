...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            # with using dropout rate of args.dropout. The dropout must be active only
            ...
            hidden_layer_dropout = tf.layers.dropout(hidden_layer, rate=args.dropout, training=self.is_training, name="hidden_layer_dropout")
