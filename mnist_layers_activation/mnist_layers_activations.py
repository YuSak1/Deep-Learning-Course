    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            if args.activation == "none":
                ...
                activation_f = getattr(tf.nn,args.activation, None)

            hidden_layer=flattened_images
            for i in range(0,args.layers):
                hidden_layer =(tf.layers.dense(hidden_layer, args.hidden_layer, activation=activation_f, name="hidden_layer"+str(i)))
