...
class Network:
    ...
    def construct(self, args, num_words, num_chars, num_tags):
        with self.session.graph.as_default():
            ...
            cnne = tf.get_variable("var_cle", shape=[num_chars, args.cle_dim])
            ...
            features=[]
            for k in range(2, args.cnne_max+1):
                conv = tf.layers.conv1d(inputs=embeded_cle, filters=args.cnne_filters, kernel_size=k,
