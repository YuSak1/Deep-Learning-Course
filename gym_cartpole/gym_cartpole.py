...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            hidden_layer0 = tf.layers.dense(self.observations, 800, activation=tf.nn.relu, name="hidden_layer0")
            #hidden_layer1 = tf.layers.dense(hidden_layer0, 400, activation=tf.nn.relu, name="hidden_layer1")
            #hidden_layer2 = tf.layers.dense(hidden_layer1, 700, activation=tf.nn.relu, name="hidden_layer2")
            output_layer = tf.layers.dense(hidden_layer0, self.ACTIONS, activation=None, name="output_layer")
